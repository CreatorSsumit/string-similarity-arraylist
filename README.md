...
Finds degree of similarity in list of array of objects , array of strings and two stings  based on Dice's Coefficient, which is mostly better than Levenshtein distance.
